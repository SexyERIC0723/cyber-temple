...
export const fortunes = [
    ...
    {id:20, title:"放下执念", level:"中签", text:"有些目标是为了"面子"而不是你真想要，适合重新审视方向。"},
    // 21-30
    ...
    {id:29, title:"投机勿贪", level:"中签", text:"短线操作可以试试，但要记住"有赚就走"。"},
    {id:30, title:"知足常乐", level:"中上签", text:"适合锁定阶段性成果，不必追求"最后一块肉"。"},
    // 31-40
    {id:31, title:"良缘在前", level:"上签", text:"单身者有机会遇到靠谱对象，宜多参加线下活动。"},
    {id:32, title:"旧情复燃", level:"中签", text:"过去的人可能重新出现，要问清楚自己"还要不要"。"},
    ...
    {id:60, title:"转机在外", level:"上签", text:"机会在"外面"而不是原地，适合主动迈出舒适圈。"},
    // 61-70
    ...
    {id:86, title:"喜忧参半", level:"中签", text:"有好结果也有代价，要接受"有得必有失"。"},
    ...
    {id:98, title:"大梦初醒", level:"中上签", text:"从一场"幻觉"里醒来，看清现实后，反而走得更稳。"},
